...
const Calificaciones = (props) => (
    <section className="AppCalificaciones">
        ...
        <ContractData drizzle={props.drizzle} drizzleState={props.drizzleState}
                      ...
                      render={ml => <ContractData drizzle={props.drizzle} drizzleState={props.drizzleState}
                                                  contract={"Asignatura"} method={"evaluacionesLength"}
                                                  render={el => <table>
        ...
        <Calificar drizzle={props.drizzle} drizzleState={props.drizzleState} />
    </section>
);
